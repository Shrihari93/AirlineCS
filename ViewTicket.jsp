...
<!-- content -->
	...
	<table>
		...
		<%
			String PNR = (String)session.getAttribute("Booking");
			Ticket ticket = (new DAOMaster()).SearchPNR(PNR);
			out.println("<tr>");
		...
		<%
			Flight flight = DAOMaster.getFlightDetails(ticket.getFlightID(),ticket.getFlightDate());
		...
		%>
		Cancel <input type="submit" name="Cancel">
